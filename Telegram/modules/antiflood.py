...
from Telegram import SARDEGNA_USERS, WHITELIST_USERS, dispatcher
...
from Telegram.modules.sql import antiflood_sql as sql
...
@skrugermsg((Filters.all & ~Filters.status_update & Filters.chat_type.groups), group=FLOOD_GROUP)
@connection_status
@loggable
...
@user_admin_no_reply
@bot_admin
@skrugercallback(pattern=r"unmute_flooder")
...
@skruger(command='setflood', pass_args=True, filters=Filters.chat_type.groups)
@connection_status
...
@skruger(command="flood", filters=Filters.chat_type.groups)
@connection_status
...
@skruger(command="setfloodmode", pass_args=True, filters=Filters.chat_type.groups)
@user_admin(AdminPerms.CAN_CHANGE_INFO)
