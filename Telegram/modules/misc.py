...
@skruger(command='id', pass_args=True)
...
@skruger(command='info', pass_args=True)
...
@skruger(command='echo', pass_args=True, filters=Filters.chat_type.groups)
@user_admin
...
@skruger(command='markdownhelp', filters=Filters.chat_type.private)
...
stats_str = '''
'''
@skruger(command='stats', can_disable=False)
@sudo_plus
def stats(update, context):
    ...
    try:
        update.effective_message.reply_text(status +
            ...
            "\n\n[⍙ GitHub](https://github.com/peyexyz) | [⍚ GitLab](https://gitlab.com/peyexyz)\n\n" +
            "╘══「 by [sena](https://t.me/peyex) 」\n",
...
@skrugercallback(pattern=r'^pingCB')
