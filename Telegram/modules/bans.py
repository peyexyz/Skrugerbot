...
@skruger(command='ban', pass_args=True)
@connection_status
@bot_admin
@can_restrict
...
@skruger(command='tban', pass_args=True)
@connection_status
@bot_admin
@can_restrict
@user_admin(AdminPerms.CAN_RESTRICT_MEMBERS)
...
@skruger(command='kick', pass_args=True)
@connection_status
@bot_admin
@can_restrict
@user_admin(AdminPerms.CAN_RESTRICT_MEMBERS)
...
@skruger(command='kickme', pass_args=True, filters=Filters.chat_type.groups)
@bot_admin
@can_restrict
...
@skruger(command='unban', pass_args=True)
@connection_status
@bot_admin
@can_restrict
@user_admin(AdminPerms.CAN_RESTRICT_MEMBERS)
...
@skruger(command='selfunban', pass_args=True)
@connection_status
@bot_admin
@can_restrict
@gloggable
