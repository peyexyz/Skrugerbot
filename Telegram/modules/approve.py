...
@skruger(command='approve', filters=Filters.chat_type.groups)
@loggable
...
@skruger(command='unapprove', filters=Filters.chat_type.groups)
@loggable
@user_admin(AdminPerms.CAN_CHANGE_INFO)
...
@skruger(command='approved', filters=Filters.chat_type.groups)
@user_admin(AdminPerms.CAN_CHANGE_INFO)
...
@skruger(command='approval', filters=Filters.chat_type.groups)
@user_admin(AdminPerms.CAN_CHANGE_INFO)
...
@skruger(command='unapproveall', filters=Filters.chat_type.groups)
...
@skrugercallback(pattern=r"unapproveall_.*")
