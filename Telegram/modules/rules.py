...
@skruger(command='rules', filters=Filters.chat_type.groups)
...
@skruger(command='setrules', filters=Filters.chat_type.groups)
...
@skruger(command='clearrules', filters=Filters.chat_type.groups)
@user_admin(AdminPerms.CAN_CHANGE_INFO)
