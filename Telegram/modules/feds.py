...
from Telegram.modules.helper_funcs.decorators import skruger, skrugercallback
...
@typing_action
@skruger(command='delfed', pass_args=True)
...
@typing_action
@skruger(command='chatfed', pass_args=True)
...
@typing_action
@skruger(command='joinfed', pass_args=True)
...
@typing_action
@skruger(command='fpromote', pass_args=True)
...
@typing_action
@skruger(command='fdemote', pass_args=True)
...
@typing_action
@skruger(command='fedinfo', pass_args=True)
...
@typing_action
@skruger(command='fedadmins', pass_args=True)
...
@typing_action
@skruger(command=['fban', 'fedban'], pass_args=True)
...
@typing_action
@skruger(command=['unfban', 'rmfedban'], pass_args=True)
...
@typing_action
@skruger(command='frules', pass_args=True)
...
@typing_action
@skruger(command='fbroadcast', pass_args=True)
...
@skruger(command='fbanlist', pass_args=True, pass_chat_data=True)
...
@typing_action
@skruger(command='fednotif', pass_args=True)
...
@typing_action
@skruger(command='fedchats', pass_args=True)
...
@typing_action
@skruger(command='importfbans', pass_args=True, pass_chat_data=True)
...
@skrugercallback(pattern=r"rmfed_")
...
@typing_action
@skruger(command='fbanstat', pass_args=True)
...
@typing_action
@skruger(command='setfedlog', pass_args=True)
...
@typing_action
@skruger(command='unsetfedlog', pass_args=True)
...
@typing_action
@skruger(command='unsubfed', pass_args=True)
...
@typing_action
@skruger(command='fedsubs', pass_args=True)
...
@typing_action
@skruger(command='myfeds', pass_args=True)
...
@skrugercallback(pattern=r"fed_help_")
