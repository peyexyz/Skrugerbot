...
@skrugermsg((Filters.regex(r"^#[^\s]+")), group=-14)
@connection_status
...
@skrugermsg((Filters.regex(r"^/\d+$")), group=-16)
@connection_status
...
@skruger(command='removeallnotes')
...
@skrugercallback(pattern=r"notes_.*")
