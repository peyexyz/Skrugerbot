...
from .helper_funcs.decorators import skruger, skrugercallback
...
@skruger(command="raid", pass_args=True)
@bot_admin
@connection_status
@loggable
...
@skrugercallback(pattern="enable_raid=")
@connection_status
@user_admin_no_reply
@loggable
...
@skrugercallback(pattern="disable_raid=")
@connection_status
@user_admin_no_reply
@loggable
...
@skrugercallback(pattern="cancel_raid=")
@connection_status
@user_admin_no_reply
...
@skruger(command="raidactiontime", pass_args=True)
@connection_status
@user_admin(AdminPerms.CAN_CHANGE_INFO)
@loggable
def raidtime(update: Update, context: CallbackContext) -> Optional[str]:
