...
from Telegram.modules.helper_funcs.decorators import skrugerinline
...
def about(query: str, update: Update, context: CallbackContext) -> None:
    ...
    Maintained by [skruger](t.me/peyex)
    ...
    kb = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    text="Support",
                    url=f"https://t.me/skrugersupport",
                ),
                InlineKeyboardButton(
                    text="Channel",
                    url=f"https://t.me/tr4shcode",
                ),
                InlineKeyboardButton(
                    text='Ping',
            ...
            [
                InlineKeyboardButton(
                    text="GitLab",
                    url=f"https://www.gitlab.com/peyexyz",
                ),
                InlineKeyboardButton(
                    text="GitHub",
                    url="https://www.github.com/peyexyz",
                ),
            ],
        ])
...
def media_query(query: str, update: Update, context: CallbackContext) -> None:
    ...
    try:
        ...
        for data in res:
            ...
            bannerimg = data.get("bannerImage") or "https://telegra.ph/file/59b82613f06ee6f8b28fd.jpg"
            try:
            ...
            genres = ", ".join(genres)
            img = f"https://telegra.ph/file/59b82613f06ee6f8b28fd.jpg"
