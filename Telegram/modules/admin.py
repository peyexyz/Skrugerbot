...
@skruger(command="promote", can_disable=False)
@connection_status
@bot_admin
@can_promote
...
@skruger(command="demote", can_disable=False)
@connection_status
@bot_admin
@can_promote
@user_admin(AdminPerms.CAN_PROMOTE_MEMBERS)
...
"""
@skruger(command="admincache", can_disable=False)
@u_admin
...
@skruger(command="title", can_disable=False)
@connection_status
@bot_admin
@can_promote
@user_admin(AdminPerms.CAN_PROMOTE_MEMBERS)
...
@skruger(command="pin", can_disable=False)
@bot_admin
@can_pin
...
@skruger(command="unpin", can_disable=False)
@bot_admin
@can_pin
@user_admin(AdminPerms.CAN_PIN_MESSAGES)
@loggable
...
@skruger(command="invitelink", can_disable=False)
@bot_admin
...
@skruger(command=["admin", "admins", "staff"])
