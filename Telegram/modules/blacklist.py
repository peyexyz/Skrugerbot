...
@skruger(command="blacklist", pass_args=True, admin_ok=True)
@u_admin
@typing_action
...
@skruger(command="addblacklist", pass_args=True)
...
@skruger(command="unblacklist", pass_args=True)
@user_admin(AdminPerms.CAN_DELETE_MESSAGES)
@typing_action
...
@skruger(command="blacklistmode", pass_args=True)
@loggable
...
@skrugermsg(((Filters.text | Filters.command | Filters.sticker | Filters.photo) & Filters.chat_type.groups), group=BLACKLIST_GROUP)
@user_not_admin
