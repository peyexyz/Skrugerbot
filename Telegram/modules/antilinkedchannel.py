...
from Telegram.modules.helper_funcs.chat_status import bot_admin, bot_can_delete

from Telegram.modules.helper_funcs.decorators import skruger, skrugermsg
from ..modules.helper_funcs.anonymous import user_admin, AdminPerms
import Telegram.modules.sql.antilinkedchannel_sql as sql


@skruger(command="antilinkedchan", group=112)
@bot_can_delete
...
@skrugermsg(Filters.is_automatic_forward, group=111)
...
@skruger(command="antichannelpin", group=114)
@bot_admin
@user_admin(AdminPerms.CAN_RESTRICT_MEMBERS)
...
@skrugermsg(Filters.is_automatic_forward | Filters.status_update.pinned_message, group=113)
def eliminate_linked_channel_msg(update: Update, _: CallbackContext):
    message = update.effective_message
    chat = update.effective_chat
