...
@skrugermsg(Filters.regex("(?i)^brb"), friendly="afk", group=3)
@skruger(command="afk", group=3)
...
@skrugermsg((Filters.all & Filters.chat_type.groups), friendly='afk', group=1)
...
@skrugermsg((Filters.entity(MessageEntity.MENTION) | Filters.entity(MessageEntity.TEXT_MENTION) & Filters.chat_type.groups), friendly='afk', group=8)
