...
from Telegram.modules.helper_funcs.decorators import skruger
...
@skruger(command='removewhitelist')
@sudo_plus
@gloggable
...
@skruger(command='removesardegna')
@sudo_plus
@gloggable
...
nations = """ skruger has bot access levels we call as *"Nation Levels"*
...
Owner has complete bot access, including bot adminship in chats skruger is at.
\n*Royals* - Have super user access, can gban, manage Nations lower than them and are admins in Kigyō.
\n*Sakuras* - Have access go globally ban users across skruger.
...
Report abuse or ask us more on these at [Null-coder](https://t.me/Shubhanshutya).
"""
...
@skruger(command=["supportlist", "sakuras"])
@whitelist_plus
...
@skruger(command=["sudolist", "royals"])
@whitelist_plus
