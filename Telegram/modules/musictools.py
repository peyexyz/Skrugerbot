...
from Telegram import call_py, telethn as skruger, client as Client
owner = "1865232417"
...
btnn =[
    [Button.url("sᴜᴘᴘᴏʀᴛ ", url=f"t.me/{Config.SUPPORT}"), Button.url("ᴀʙᴏᴜᴛ sᴇɴᴀ ", url=f"t.me/{Config.CHANNEL}")],
...
@skruger.on(events.NewMessage(pattern="^[?!/.]vplay"))
@AssistantAdd
...
#playlist
@skruger.on(events.NewMessage(pattern="^[?!/.]playlist"))
@is_admin
...
#leavevc
@skruger.on(events.NewMessage(pattern="^[?!/.]leavevc"))
@is_admin
...
@skruger.on(events.NewMessage(pattern="^[?!/.]skip"))
@is_admin
...
@skruger.on(events.NewMessage(pattern="^[?!/.]pause"))
@is_admin
...
@skruger.on(events.NewMessage(pattern="^[?!/.]resume"))
@is_admin
