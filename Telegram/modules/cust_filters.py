...
from Telegram import dispatcher, log, SUDO_USERS
from Telegram.modules.helper_funcs.extraction import extract_text
from Telegram.modules.helper_funcs.filters import CustomFilters
from Telegram.modules.helper_funcs.misc import build_keyboard_parser
from Telegram.modules.helper_funcs.msg_types import get_filter_type
...
from Telegram.modules.sql import cust_filters_sql as sql
...
from Telegram.modules.helper_funcs.decorators import skruger, skrugermsg, skrugercallback
...
@typing_action
@skruger(command='filters', admin_ok=True)
...
@skruger(command='filter', run_async=False)
...
# NOT ASYNC BECAUSE DISPATCHER HANDLER RAISED
@skruger(command='stop', run_async=False)
@user_admin(AdminPerms.CAN_CHANGE_INFO)
@typing_action
...
@skrugermsg((CustomFilters.has_text & ~Filters.update.edited_message))
...
@skruger(command="removeallfilters", filters=Filters.chat_type.groups)
...
@skrugercallback(pattern=r"filters_.*")
