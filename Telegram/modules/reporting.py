...
@skruger(command='report', filters=Filters.chat_type.groups, group=REPORT_GROUP)
@skrugermsg((Filters.regex(r"(?i)@admin(s)?")), group=REPORT_GROUP)
@user_not_admin
@loggable
...
@skrugercallback(pattern=r"report_")
