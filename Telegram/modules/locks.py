...
import Telegram.modules.sql.locks_sql as sql
from Telegram import dispatcher, log
...
@skruger(command='lock', pass_args=True)
...
@skruger(command='unlock', pass_args=True)
@user_admin(AdminPerms.CAN_CHANGE_INFO)
@loggable
@typing_action
...
@skrugermsg((Filters.all & Filters.chat_type.groups), group=PERM_GROUP)
@user_not_admin
